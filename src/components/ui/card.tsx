...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.5rem] border border-border/60 bg-card/90 text-card-foreground shadow-[0_18px_36px_rgba(7,28,85,0.08)] backdrop-blur-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-xl font-semibold leading-tight tracking-[-0.02em] sm:text-2xl",
      className
    )}
    {...props}
  />
